...
```
### Assignment 6
<h4>Conversion_Rate</h4>
<p><b>Decide how many Factors are ideal for your dataset</b></p>
<p>I am Using 4 Factors for this Assignment</p>

<p><b>Explain the output for your factor model</b></p>
<p>In analyzing the data, I found two main factors, MR1 and MR2. Factor 1 is primarily influenced by "Avg_Session_Duration", "Total_Sessions", and "Total_revenue". These variables play significant roles in determining the outcome of Factor 1. On the other hand, Factor 2 is  "Conversion_Rate". However, Factor 3 doesn't significantly impact the analysis as none of the variables have substantial loadings on this factor.</p>

<p><b>Show the columns that go into each factor and Perform some visualizations using the factors</b></p>
